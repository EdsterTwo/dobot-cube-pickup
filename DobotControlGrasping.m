...
% Edan Anonuevo - 13925490
% Ricardo Rios - 13208335
% Shan-E Hassan Syed Jaffery - 13844105

close all;

%% Camera Calibration
% Rosbag
calibBag = rosbag('20231023_190845.bag');
...
figure 
imshow(calibImageRGB{30})

% ImageFolder = '/home/ricrios/snc/Assignment 2';
% ImageFolder = '/Users/edananonuevo/MATLAB-Drive/rosbag test';
ImageFolder = 'C:\Users\Edan Anonuevo\MATLAB Drive\rosbag test';
for i = 1:numImages
...
%% Feature Extraction
% Read rosbags
coordBag = rosbag('20231023_204537.bag');
...
plot(centroids(2, 1), centroids(2, 2), 'go', 'MarkerSize', 10);     % End-Effector
hold off;
...
rotation = [0,0,0];
startPos = [0.2,0,0.01];
pickupPos = [dobotX,dobotZ,0.1];
depositPos = [0.3,0.3,0.1];

pickupOver = [pickupPos(1),pickupPos(2),pickupPos(3)+0.05];
pickupDown = pickupPos;
depositOver = [depositPos(1),depositPos(2),depositPos(3)+0.05];
